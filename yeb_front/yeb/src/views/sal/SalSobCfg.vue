<template>
    <div>
        <el-table :data="emps"
            ...
            <el-table-column prop="name" label="姓名" align="left" width="120" fixed></el-table-column>
            ...
            <el-table-column prop="department.name" label="所属部门" align="left" width="120"></el-table-column>
